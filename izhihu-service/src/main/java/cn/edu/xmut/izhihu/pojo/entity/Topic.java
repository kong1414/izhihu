...
public class Topic {
     ...
     */
    public String getTopicFatherId() {
     ...
     */
    public void setTopicFatherId(String topicFatherId) {
        this.topicFatherId = topicFatherId == null ? null : topicFatherId.trim();
    }
